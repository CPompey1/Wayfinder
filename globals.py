...
EMITTER_LOC_DICT = {    
                            ...
                            "DD:34:02:08:FA:9A": [39.5, 79.5, 107.75],         #test8  (updated)
                            ...
                            "00:3C:84:20:E6:7C": [15.2, 81.0, 108],            #test77 (updated)
                            ...
                            "84:BA:20:6E:3B:67": [13.3, -19.1, 307.58],        #test22               3rd floor
                            ...
                            "BC:02:6E:9C:72:94": [-30.1, 18.0, 308.92],        #test35 (updated)
                            "BC:02:6E:9C:87:F6": [54.5, 54.5, 308.42],         #test36 (updated)
                            "00:3C:84:2A:C0:79": [-6.5, 54.5, 309],            #test37 (updated)
                            "00:3C:84:22:31:FB": [50.0, 108.0, 308],           #test78 (updated)
                            "00:3C:84:2A:B8:97": [12.0, -19.5, 408],           #test38 (updated)      4th floor
                            "54:0F:57:D0:80:73": [-40.5, -55.2, 407.92],       #test39 (updated) 
                            ...
                            "00:3C:84:20:E3:DC": [-25.5, 144.0, 407.25],       #test51 (updated)
                            ...
                            "54:0F:57:D0:7B:0D": [86.0, 144.0, 400],           #test79 (updated)
                            ...
                            "00:3C:84:28:7E:19": [83.5, 17.5, 508.33],         #test63 (updated)
                            "84:BA:20:6E:38:4B": [67.5, 54.3, 508.5],          #test64 (updated)
                            "84:BA:20:90:20:8A": [67.5, 108.8, 508.5],         #test65 (updated)
                            "00:3C:84:2A:BD:45": [51.4, 128.6, 508.5],         #test66 (updated)
                            "00:3C:84:22:36:09": [13.5, 127.9, 508.5],         #test67 (updated)
                            ...
                            "84:BA:20:6E:39:98": [-21.5, 102.5, 508],          #test81 (updated)
                            }
...
PIXELS_PER_GRID_FLOOR_4_X = 17
PIXELS_PER_GRID_FLOOR_4_Y = 15
ELEVATOR_PIXEL_X_FLOOR_4 = 185
ELEVATOR_PIXEL_Y_FLOOR_4 = 436

PIXELS_PER_GRID_FLOOR_5_X = 18
PIXELS_PER_GRID_FLOOR_5_Y = 15
...
class SharedData:
    ...
    def get_estimated_location(self):
        with self.lock:
            out = (self.estimated_location[0], self.estimated_location[1], round(self.estimated_location[2]))
        return out
