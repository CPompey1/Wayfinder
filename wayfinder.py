    ...
    def select_service(self):
        ...
        def onselect(evt: Event):
            ...
            # Note here that Tkinter passes an event object to onselect()
                ...
                room_frame.grid(column=1, row=0, sticky=(N,W,S))
                floor_array = {}
                ...
                room_list = tk.Listbox(room_frame, height=13, font=FONT_SERVICES, name='room_list', selectmode="SINGLE", listvariable=floor_array.values()).pack() #, width=10, height=1024)
                ...
                '''for floor_groups in floor_array.values():
        ...
        services_frame.grid(column=0, row=0, sticky=(N, S, W))

        #services_frame.pack_propagate(0)
        services_list = Listbox(services_frame, height = len(self.service_array), font=FONT, name='service_list') #, width=10, height=1024)
